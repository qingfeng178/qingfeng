...
[rewrite_local]
^https?:\/\/buy\.itunes\.apple\.com\/verifyReceipt$ url script-response-body https://raw.githubusercontent.com/qingfeng178/qingfeng/main/heji.js
...
*/
var qf1 = {};
var qf2 = JSON.parse(typeof $response != "undefined" && $response.body || null);
var headers = {};
...
var uaProductMapping = {
  ...
  'CCD_Camera': {product_id: 'qf'},
  'CHAT%20AI': {product_id: 'qf'},
  'Koloro': {product_id: 'qf'},
  'AllMyBatteries': {product_id: 'qf'},
